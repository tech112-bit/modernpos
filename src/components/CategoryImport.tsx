  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-medium text-gray-900">Bulk Category Import</h3>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-800">Import Information</h3>
            <div className="mt-2 text-sm text-blue-700">
              <p>• Categories with existing names will be updated with new descriptions</p>
